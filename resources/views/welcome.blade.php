    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium text-2xl">Sistem E-Voting RT</h1>
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Platform demokratis untuk pemilihan Ketua RT.
                    <br>Transparan, aman, dan mudah digunakan.</p>
                    ...
                    <li
                        ...
                        <span>
                            ...
                            <a href="{{ route('vote.categories') }}"
                                class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 text-emerald-600 dark:text-emerald-500 ml-1">
            ...
            <div
                ...
                {{-- Laravel Logo --}}
                <svg class="w-full text-emerald-600 dark:text-emerald-500 transition-all translate-y-0 opacity-100 max-w-none duration-750 starting:opacity-0 starting:translate-y-6"
