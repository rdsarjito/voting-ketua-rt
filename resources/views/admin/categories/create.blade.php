    ...
    <div class="bg-white dark:bg-gray-800 p-4 rounded shadow max-w-2xl">
        <form method="POST" action="{{ route('admin.categories.store') }}">
            ...
            <div class="mb-4">
                ...
                <input type="datetime-local" name="voting_start" value="{{ old('voting_start') }}" class="w-full border rounded p-2 bg-gray-100 dark:bg-gray-700" />
            ...
            <div class="mb-4">
                ...
                <input type="datetime-local" name="voting_end" value="{{ old('voting_end') }}" class="w-full border rounded p-2 bg-gray-100 dark:bg-gray-700" />
